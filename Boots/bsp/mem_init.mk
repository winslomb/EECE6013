...
# Memory: Onchip_SRAM_2
MEM_1 := nios_system_Onchip_SRAM_2
$(MEM_1)_NAME := Onchip_SRAM_2
...
$(MEM_1)_HIERARCHICAL_PATH := Onchip_SRAM_2
$(MEM_1)_WIDTH := 32
...
.PHONY: Onchip_SRAM_2
Onchip_SRAM_2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
